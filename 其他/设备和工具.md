...
# 同步 docker 数据：周一至周五，每天凌晨 4 点；/home/docker/docker/volumes/ -> /media/yan/hc330-10t-A/dockerData/
00 04 * * 1-5 /home/yan/apply/file/FreeFileSync/sava/batch/start_backup_task.sh /docker/docker-um773-hc330A.ffs_batch
...
*/.stfolder/*
*/.stversions/*
/homeassistant/config/.storage/xiaomi_miot/urn:miot-spec-v2*
...
![|700](attachments/Pasted%20image%2020250108090528.png)
...
![|700](attachments/Pasted%20image%2020250108090730.png)

2. 第一次进入需设置密码
3. 界面：

![|700](attachments/Pasted%20image%2020250108090706.png)
...
### ②、AList-desktop ubuntu gui 桌面版的安装
...
### ③、alist-desktop gui 桌面版安装后，点击桌面图标没反应
...
![](attachments/Pasted%20image%2020250108101018.png)
...
![|700](attachments/Pasted%20image%2020250108101059.png)

9. 点击保存即可集成，成功后下方会显示常用设置等

### ⑤、修改 Nextcloud 集成 Onlyoffice 后的页面的样式
...
### ⑥、使用 Nginx 反向代理 Nextcloud 并配置 HTTPS 访问
...
## 7、Onlyoffice 提供文档、电子表格、演示文稿等工具
...
![|700](attachments/Pasted%20image%2020250108102246.png)

4. 将下载的压缩文件解压，得到下面的四个文件：

![|700](attachments/Pasted%20image%2020250108102258.png)
...
![](attachments/Pasted%20image%2020250108102325.png)
...
![|700](attachments/Pasted%20image%2020250108102354.png)

## 8、Memos 开源、轻量级的备忘录服务
...
## 9、2FAuth 基于 Web 的自托管 2FA 双因素认证替代方案
...
## 13、NapCatQQ 基于 TypeScript 构建的 QQ Node 模块
...
#### Ⅱ、将 NapCatQQ 作为 java 端的服务器

1. 点击网络配置 -> 添加配置
	1. 名称：比如：`将 NapCatQQ 作为 java 端的服务器`
	2. 类型：WebSocket 服务器
...
#### Ⅲ、将 NapCatQQ 接入 onebot11 的服务端

1. 继续看下面的 nonebot-bison 的部署和使用

## 14、nonebot-bison 通用订阅推送插件机器人
...
![](attachments/Pasted%20image%2020250108110632.png)
...
![](attachments/Pasted%20image%2020250108111238.png)
...
![](attachments/Pasted%20image%2020250107164810.png)

2. 创建表

![](attachments/Pasted%20image%2020250107164827.png)

3. 添加数据

![](attachments/Pasted%20image%2020250107164845.png)
...
![](attachments/Pasted%20image%2020250107165410.png)
