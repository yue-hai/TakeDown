...
1. 访问：[http://www.yue-hai.top:10000](http://www.yue-hai.top:10000)
...
1. 访问迅雷迅雷群晖提取版网页： [http://www.yue-hai.top:10001](http://www.yue-hai.top:10001)
2. 扫码或使用账号密码登录
...
2. 访问：[http://www.yue-hai.top:10003](http://www.yue-hai.top:10003)
...
2. 访问：[http://www.yue-hai.top:10004](http://www.yue-hai.top:10004)，进入主页面，输入账号 admin 以及刚才查看的密码进行登录
3. 登录成功后，点击工具 -> 选项 -> 连接，通过刚才查看的密码，修改新密码

### ⑤、Nextcloud 自托管云存储和协作平台

> github 项目地址：https://github.com/55190116/nextcloud-docker
> 
> 该项目需要关联一个数据作为数据的存取
...
1. 访问：[http://www.yue-hai.top:10010](http://www.yue-hai.top:10010)
2. 第一次进入需设置账号、密码、数据库信息

### ⑥、Onlyoffice 提供文档、电子表格、演示文稿等工具
...
1. 访问：[http://www.yue-hai.top:10011](http://www.yue-hai.top:10011)，出现下面页面则部署成功

![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203135259.png)

2. 执行下面两条命令，启动 onlyoffice：
...
![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203135533.png)

4. 在测试示例页面，可选择语言，选择后地址栏上会带上参数：`lang=zh`，建议将此时的地址存为书签，因为语言的设置并不会保存，只能以地址参数设置

![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203140037.png)

5. 可尝试新建或上传一个文档，测试可用性

![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203140135.png)

![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203140148.png)
...
1. 访问：[http://www.yue-hai.top:10012](http://www.yue-hai.top:10012)
2. 初次访问需设定管理员账号密码
...
1. 访问：[http://www.yue-hai.top:10020](http://www.yue-hai.top:10020)
2. 初次访问需设定管理员账号密码
...
![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203153332.png)
...
![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203153604.png)

3. 即可查看设定的媒体库

![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203153736.png)

#### Ⅵ、https 设置

> 获取证书的方式：[使用 Let's Encrypt 免费获取证书](../编程相关/网络相关.md#1-1)
...
![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203154219.png)

3. 在 HTTPS 设置中，选择刚才复制的 `mykeystore.p12` 文件，填入证书密码，然后重启服务器即可

![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241203154357.png)

4. 成功后访问 https 端口：[http://www.yue-hai.top:10021](http://www.yue-hai.top:10021)

### ⑨、navidrome 开源的、自托管的音乐流媒体服务器
...
1. 访问：[http://www.yue-hai.top:10022](http://www.yue-hai.top:10022)
2. 初次访问需设定管理员账号密码
...
1. 访问：[http://www.yue-hai.top:10070](http://www.yue-hai.top:10070)
2. 初次访问需设定管理员账号密码
...
1. 访问：[http://www.yue-hai.top:10071](http://www.yue-hai.top:10071)
2. 初次访问需设定管理员账号密码
...
![|700](https://www.yue-hai.top:10300/file/downloadPublicFile?basePathType=takeDown&subPath=%2F%E5%85%B6%E4%BB%96%2Fattachments%2FPasted%20image%2020241120104606.png)
