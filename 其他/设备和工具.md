...
> 我的 RealTimeSync 脚本保存在：`/home/yan/apply/file/FreeFileSync/sava/batch/` 目录下

1. 将 XVFB 与 FreeFileSync 整合到脚本，在启动 XVFB 后自动运行 FreeFileSync：
...
# 执行 FreeFileSync 进行同步任务
# 使用 FreeFileSync 配置文件 document-um773-hc330.ffs_batch 指定同步任务
/home/yan/apply/file/FreeFileSync/FreeFileSync /home/yan/apply/file/FreeFileSync/sava/batch/document-um773-hc330.ffs_batch
```
...
2. 设置周一至周五的每天凌晨 2 点运行

```shell
# 同步文档资料：周一至周五，每天凌晨 2 点；/home/yan/桌面/内存/文档资料/ -> /media/yan/hc330-10t/内存/文档资料/
00 02 * * 1-5 /home/yan/apply/file/FreeFileSync/sava/start_backing_documents.sh
```
