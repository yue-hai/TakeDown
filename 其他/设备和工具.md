...
restart_path="/home/yan/apply/n2n-edge-query-check/"
...
# 尝试访问 API
if curl --fail --silent --output /dev/null "$API_URL"; then
    # API 访问成功，保存日志
...
back_path="/home/yan/apply/n2n-edge-query/"
# 重启【查询 n2n edge 节点信息】后台服务脚本所在路径
restart_path="/home/yan/apply/n2n-edge-query-check/"
...
0 8 * * * /home/yan/apply/n2n-edge-query-check/check-n2n-edge-query-back.sh
# 检查【查询 n2n edge 节点信息】接口是否可以访问的脚本，每天 12 点执行
0 12 * * * /home/yan/apply/n2n-edge-query-check/check-n2n-edge-query-back.sh
# 检查【查询 n2n edge 节点信息】接口是否可以访问的脚本，每天 18 点执行
0 18 * * * /home/yan/apply/n2n-edge-query-check/check-n2n-edge-query-back.sh
```
