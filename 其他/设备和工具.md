...
13. 根据上面知道服务器 ip：`101.200.86.248:32222`，和应该加入的小组：`123456`，则启动命令为：
...
16. 此时在 windows 系统上同时连接上 n2n 客户端，点击小组名称后的按钮，打开已连接的主机列表，发现多了一个客户端，且虚拟 ip 与刚才设置的相同，即为连接成功，双击列表项查看延迟
