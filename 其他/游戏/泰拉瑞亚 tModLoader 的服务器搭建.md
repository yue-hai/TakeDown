...
2. 进入后点击手动添加，下方会出现设置
	...
	4. 端口范围：若是选择的自定义 TCP，则输入泰拉的端口号 `7777`；若是选择了全部则不需输入
	5. 授权对象：`0.0.0.0/0`
	6. 描述：随意
	7. 操作：上面的都设置好后，点击保存
...
3. 下载 dotnet 6.0.0，1.4 的联机依赖 dotnet
...
5. dotnet 6.0.418 分卷压缩包下载：
	...
	4. [dotnet-sdk-6.0.418-linux-x64.zip.004](attachments/dotnet-sdk-6.0.418-linux-x64.tar.zip.004)
