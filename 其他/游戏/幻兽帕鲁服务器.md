...
echo "【${current_time}】帕鲁服务器已重启完成" >> /home/steam/Steam/steamapps/common/PalServer/yuehai_server.log
echo "" >> /home/steam/Steam/steamapps/common/PalServer/yuehai_server.log

echo "【${current_time}】帕鲁服务器已重启完成"
```
...
echo "" >> ${path}/yuehai_server.log

echo "【${current_time}】帕鲁服务器已关闭"
```
...
1. 服务器配置文件：`~/Steam/steamapps/common/PalServer/Pal/Saved/Config/LinuxServer/PalWorldSettings.ini`
