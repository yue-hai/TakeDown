...
2. 进入后点击手动添加，下方会出现设置
	...
	4. 端口范围：若是选择了全部则不需输入；若是选择的自定义 TCP，则输入游戏的端口号 `29600`、`29602`
	5. 授权对象：`0.0.0.0/0`
	6. 描述：随意
	7. 操作：上面的都设置好后，点击保存
...
4. Mods 目录：`"~/Steam/steamapps/common/7 Days to Die Dedicated Server/Mods"`
	...
	3. mod 目录的名字不要使用中文
5. 服务器配置文件：`"~/Steam/steamapps/common/7 Days to Die Dedicated Server/serverconfig.xml"`
6. 服务端存档目录：`~/.local/share/7DaysToDie/Saves`
