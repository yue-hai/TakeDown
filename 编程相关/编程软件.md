...
> - 对应 2023.3.2 版本，手动配置：[jihuo-tool-2023.3.2-手动.zip](attachments/jihuo-tool-2023.3.2-手动.zip)
> - 对应 2023.3.2 版本，自动配置：[jihuo-tool-2023.3.2-自动.zip](attachments/jihuo-tool-2023.3.2-自动.zip)
...
![|700](attachments/Pasted%20image%2020240130140955.png)
...
3. 下载上面的手动配置的对应版本激活文件：[jihuo-tool-2023.3.2-手动.zip](attachments/jihuo-tool-2023.3.2-手动.zip)；解压到英文目录，注意此文件使用后不可删除
4. 进入到 idea，选择菜单栏 `Help -> Edit Custom VM Properties…`  ，打开 idea 参数配置文件，如下：

![|591](attachments/Pasted%20image%2020240130141404.png)
...
![|445](attachments/Pasted%20image%2020240130142508.png)

8. 选择移除许可证

![|700](attachments/Pasted%20image%2020240130142621.png)

9. 新页面中，选择 `Activate IntelliJ IDEA`，然后选择 `Activation code`，输入下面的激活码

![|622](attachments/Pasted%20image%2020240130150253.png)

10. 点击 `Activate`，激活完成

![|600](attachments/Pasted%20image%2020240130142802.png)

### ③、自动配置

1. 配置 java 环境
2. 下载上面的自动配置的对应版本激活文件：[jihuo-tool-2023.3.2-自动.zip](attachments/jihuo-tool-2023.3.2-自动.zip)；解压到英文目录，注意此文件使用后不可删除
...
![|354](attachments/Pasted%20image%2020240130145606.png)

4. 点击确定，执行过程中，需要大概 10-30 秒时间（也可能需要几分钟，时间不固定）。看到提示 Done 时，继续下面的步骤。

![|124](attachments/Pasted%20image%2020240130145640.png)

5. 打开（重启）idea，选择 `Activate IntelliJ IDEA`，然后选择 `Activation code`，输入下面的激活码

![|622](attachments/Pasted%20image%2020240130150415.png)

6. 点击 `Activate`，激活完成

![](attachments/Pasted%20image%2020240130142802.png)

## 2、插件

### ①、阿里编码指南：Alibaba Java Coding Guidelines

![](attachments/Pasted%20image%2020231213104054.png)
...
![](attachments/Pasted%20image%2020231213104107.png)
...
![](attachments/Pasted%20image%2020231213104407.png)
...
![](attachments/Pasted%20image%2020231213123257.png)
 
### ③、中文语言包：Chinese ​(Simplified)​ Language Pack / 中文语言包

![](attachments/Pasted%20image%2020231213123734.png)
...
![](attachments/Pasted%20image%2020231213123909.png)
...
![](attachments/Pasted%20image%2020231213124021.png)
...
![|700](attachments/Pasted%20image%2020231213124222.png)

### ⑥、彩虹括号：Rainbow Brackets

> 高版本的收费了，这里提供一个低版本的：
> 
> [intellij-rainbow-brackets-6.26.zip](attachments/intellij-rainbow-brackets-6.26.zip)
> 1
> 若是想使用高版本，这里提供一个破解方法：https://github.com/starxg/RainbowBracketsCrack

![](attachments/Pasted%20image%2020231213125724.png)

1. 名称：`Rainbow Brackets`
2. 功能：将括号变为彩虹配色

![|700](attachments/Pasted%20image%2020231213125926.png)

![|700](attachments/Pasted%20image%2020231213125932.png)

### ⑦、显示操作的快捷键：Key Promoter X

![](attachments/Pasted%20image%2020231213130228.png)

1. 名称：`Key Promoter X`
2. 功能：当用使用鼠标点击进行操作时，若是该操作有对应的快捷键，会在屏幕上进行显示

![](attachments/动画45.gif)

### ⑧、显示使用的快捷键：Presentation Assistant

![](attachments/Pasted%20image%2020231213130505.png)

1. 名称：`Presentation Assistant`
2. 功能：按使用快捷键时，在屏幕上显示使用的快捷键

![](attachments/Pasted%20image%2020231213130359.png)

### ⑨、自动切换输入法：Smart Input

![](attachments/Pasted%20image%2020231213130518.png)

1. 名称：`Smart Input`
2. 功能：当光标改变时，插件会根据上下文改变输入法的中英文输入方式

![](attachments/screenshot_7374adc2-e0f2-4ed1-8972-5f36a9ee77c0.gif)

### ⑩、翻译插件：Translation

![](attachments/Pasted%20image%2020231213130819.png)

1. 名称：`Translation`
2. 功能：可在 idea 中一键翻译，支持多种翻译引擎

![|700](attachments/Pasted%20image%2020231213130953.png)

### ⑪、uml 图插件：PlantUML Integration

![](attachments/Pasted%20image%2020231213131142.png)

1. 名称：`PlantUML Integration`
2. 功能：可通过代码生成 uml 图

![|700](attachments/Pasted%20image%2020231213131120.png)

### ⑫、ai 代码提示：Tabnine: AI Code Completion & Chat in Java JS/TS Python & More

![](attachments/Pasted%20image%2020231213132252.png)

1. 名称：`Tabnine: AI Code Completion & Chat in Java JS/TS Python & More`
2. 功能：老牌 ai 代码提示工具，单行代码补全很厉害

![|700](attachments/screenshot_9ed3e252-5895-4980-8a33-81c2341be8b2.gif)

![|700](attachments/screenshot_5d921685-e6ae-4c70-92f0-b1eeb3afdae6.gif)

### ⑬、ai 代码提示：GitHub Copilot

![](attachments/Pasted%20image%2020231213132234.png)

1. 名称：`GitHub Copilot`
2. 功能：基于 github 和 chatGpt 的代码提示，更精于预测代码和编写多行代码

![|700](attachments/screenshot_72dd36c5-4db8-4f8a-9c65-8994b537df95.gif)

![|700](attachments/screenshot_947ab994-aec2-4050-91a5-b3b28106b35f.gif)
...
![](attachments/Pasted%20image%2020231213142550.png)
...
![](attachments/Pasted%20image%2020231213142619.png)

1. 名称：`SonarLint`
2. 功能：实时检测代码，不规范会给出提示

![](attachments/sonarlint-rule-description.gif)

### ③、idea 快捷键：IntelliJ IDEA Keybindings

![](attachments/Pasted%20image%2020231213142631.png)
...
![](attachments/Pasted%20image%2020231213142645.png)

1. 名称：`aiXcoder Code Completer`
2. 功能：ai 代码提示、代码补全

![|561](attachments/python_example.gif)

![|700](attachments/java_example.gif)

### ⑤、彩虹缩进：indent-rainbow

![](attachments/Pasted%20image%2020231213142658.png)

1. 名称：`indent-rainbow`
2. 功能：对文本前面的缩进进行着色，使用不同的颜色对缩进进行显示

![](attachments/Pasted%20image%2020231213133537.png)

### ⑥、实时服务器：Live Server

![](attachments/Pasted%20image%2020231213142708.png)
...
![](attachments/Pasted%20image%2020231213142720.png)
...
![|700](attachments/ppz.vscode.gif)

### ⑧、远程连接 linux 服务器：Remote - SSH

![](attachments/Pasted%20image%2020231213142738.png)
...
![](attachments/Pasted%20image%2020231213142749.png)
...
![](attachments/math.gif)

### ⑩、shell 语法错误检查：shellcheck

![](attachments/Pasted%20image%2020231213142801.png)

1. 名称：`shellcheck`
2. 功能：shell 语法错误检查

![](attachments/Pasted%20image%2020231213135604.png)

### ⑪、shell 格式化：shell-format

![](attachments/Pasted%20image%2020231213142809.png)
...
![](attachments/shell_format.gif)

### ⑫、html 与 css 代码提示：HTML CSS Support

![](attachments/Pasted%20image%2020231213142823.png)
...
![](attachments/Pasted%20image%2020231213142841.png)

1. 名称：`Vue 3 Snippets`
2. 功能：vue 3 的代码片段提示工具

![](attachments/VueInit.gif)

### ⑭、vue 3 语言特性支持：Vue Language Features (Volar)

![](attachments/Pasted%20image%2020231213142850.png)
...
![](attachments/Pasted%20image%2020231213142903.png)
...
1. 2.6.0 下载： [WindTerm_2.6.0.zip](attachments/WindTerm_2.6.0.zip)
