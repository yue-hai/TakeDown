...
> 
> [Docker2022.docx](attachments/Docker2022.docx)
...
4. 环境配置相当麻烦，换一台机器，就要重来一次，费力费时。很多人想到，能不能从根本上解决问题，软件可以带环境安装？也就是说，安装的时候，把原始环境一模一样地复制过来。开发人员利用 Docker 可以消除协作编码时“在我的机器上可正常工作”的问题。
 ...
 ![image.png](attachments/2023-07-25-12--42-54-941--qYVcwgsYMPP9_Q.png)
...
2. Docker 的主要目标是“Build，Ship and Run Any App,Anywhere”，也就是通过对应用组件的封装、分发、部署、运行等生命周期的管理，使用户的APP（可以是一个WEB应用或数据库应用等等）及其运行环境能够做到“一次镜像，处处运行”。
 ...
 ![image.png](attachments/2023-07-25-12--42-55-389--s7CFyZXxaQjCQg.png)
...
![image.png](attachments/2023-07-25-12--42-55-411--bsLIxHzb5ApRLQ.png)

![image.png](attachments/2023-07-25-12--42-55-430--S5PhAew7b5onLQ.png)
...
![image.png](attachments/2023-07-25-12--42-55-463--Hsss7NYFVVYV6Q.png)

![image.png](attachments/2023-07-25-12--42-55-479--dZsQIIEg-erEHw.png)
...
![image.png](attachments/2023-07-25-12--42-55-497--ClK2kw-a-jp2YQ.png)

![image.png](attachments/2023-07-25-12--42-55-513--8OqIPPXTIE8Uow.png)

### ④、对比

![image.png](attachments/2023-07-25-12--42-55-524--EPKoEEksVp_Y9A.png)
...
![image.png](attachments/2023-07-25-12--42-55-540--0AhOQVwDqBZeIw.png)

3. 哪些企业在使用
   1. 新浪

![image.png](attachments/2023-07-25-12--42-55-564--_kZs9aGMRUT9Wg.png)

   2. 美团

![image.png](attachments/2023-07-25-12--42-55-586--eDNctxftQXFPLA.png)

   3. 蘑菇街

![image.png](attachments/2023-07-25-12--42-55-629--UWP0Uvw_rLWBcQ.png)
...
![image.png](attachments/2023-07-25-12--42-55-666--70VVdU_QzRKrAQ.png)
...
![image.png](attachments/2023-07-25-12--42-55-679--HGw7pQCFgfnoJg.png)
...
![image.png](attachments/2023-07-25-12--42-55-690--jq5nZSsGTuTidw.png)

![image.png|693](attachments/2023-07-25-12--42-55-703--XL7HGwI9oVMkAw.png)
...
![image.png](attachments/2023-07-25-12--42-55-756--5mlEv7rc6mEhoA.png)
...
![image.png](attachments/2023-07-25-12--42-55-780--37QMi-ZlHNr9MA.png)

![image.png](attachments/2023-07-25-12--42-55-798--xzE-ij_j-Me2sA.png)
...
![image.png](attachments/2023-07-25-12--42-55-810--WNpRlVNfCGLZ6w.png)

![image.png](attachments/2023-07-25-12--42-55-835--yh1rhpFp5_8qpw.png)
...
![image.png](attachments/2023-07-25-12--42-55-858--ma7h6aaKYv2BKQ.png)

## 2、镜像命令

### ①、`docker images [参数]` 列出本地主机上的镜像

![image.png](attachments/2023-07-25-12--42-55-867--R_t0L0LkyJnSjw.png)
...
![image.png](attachments/2023-07-25-12--42-55-912--7m6f0y1Br0n4HA.png)
...
![image.png](attachments/2023-07-25-12--42-55-922--66ubiBCmUmGB9Q.png)

- 参数说明：`-f`：强制删除；若镜像已被使用则不可以被删除，使用此参数可以强制删除

### ⑤、`docker system df`  查看镜像/容器/数据卷所占的空间

![image.png](attachments/2023-07-25-12--42-55-930--BK1ZufKAf6AZGw.png)

## 3、容器命令

- 有镜像才能创建容器， 这是根本前提(下载一个 CentOS 或者 ubuntu 镜像演示)

![image.png](attachments/2023-07-25-12--42-55-935--kaS2B-Jndd3jdA.png)

![image.png](attachments/2023-07-25-12--42-55-944--Ne9wsP8sB48giw.png)
...
![image.png](attachments/2023-07-25-12--42-55-957--b3atknSGYJq_Pw.png)
...
![image.png](attachments/2023-07-25-12--42-55-964--O1fWiVcKyCkJRg.png)

### ⑧、查看容器内运行的进程 `docker top 容器ID`

![image.png](attachments/2023-07-25-12--42-55-975--tdPfDXkhj8Suew.png)
...
![image.png](attachments/2023-07-25-12--42-55-982--9IbQ4ZXbp3OB_w.png)
...
![image.png](attachments/2023-07-25-12--42-56-004--2m2JEsa2lLFp3A.png)
...
![image.png](attachments/2023-07-25-12--42-56-011--FgUS5EIx7Aioug.png)
...
![image.png](attachments/2023-07-25-12--42-56-082--76qtjyOu24q9Lw.png)
...
![image.png](attachments/2023-07-25-12--42-56-125--zYkro27taBBn4g.png)
...
![image.png](attachments/2023-07-25-12--42-56-188--m1hLGV6eyDeNJA.png)

## 4、本地镜像发布到阿里云
> [https://cr.console.aliyun.com/cn-hangzhou/instances](https://cr.console.aliyun.com/cn-hangzhou/instances)

![image.png](attachments/2023-07-25-12--42-56-208--svG0bCBl3ry9xg.png)

1. 阿里云开发者平台；控制台 -> 菜单 -> 容器镜像服务

![image.png](attachments/2023-07-25-12--42-56-224--antudd3qvXoPPg.png)

2. 点击进入个人实例

![image.png](attachments/2023-07-25-12--42-56-243--jeNGKTTGAsDCVA.png)

3. 仓库管理 -> 镜像仓库 -> 创建镜像仓库

![image.png](attachments/2023-07-25-12--42-56-253--zbVaC_XineQ6mg.png)

4. 选择本地仓库

![image.png](attachments/2023-07-25-12--42-56-266--SCbveU35apn8Gw.png)

5. 操作指南

![image.png](attachments/2023-07-25-12--42-56-271--n80xym8chHMcKQ.png)
...
![image.png](attachments/2023-07-25-12--42-56-284--CubX2a6bBsO6Hg.png)
...
![image.png](attachments/2023-07-25-12--42-56-292--1He0ENToLwI28Q.png)
...
![image.png](attachments/2023-07-25-12--42-56-297--C6wcjhokFrCZ0g.png)
...
![image.png](attachments/2023-07-25-12--42-56-379--3K3iuQdzSIK6CA.png)
...
![image.png](attachments/2023-07-25-12--42-56-412--YHFEoen9zU-sJQ.png)
...
![image.png](attachments/2023-07-25-12--42-56-432--pPJCSdBDHZzF3w.png)
...
![image.png](attachments/2023-07-25-12--42-56-443--nu-ckAqQJcClWg.png)
...
![image.png](attachments/2023-07-25-12--42-56-458--DWtoCfSGHScgiA.png)
...
![image.png](attachments/2023-07-25-12--42-56-463--392SZE1YppZV4w.png)

4. 将项目打成 jar 包

![image.png](attachments/2023-07-25-12--42-56-469--GNdk7QRWkYJn_g.png)

5. 将生成的 `Boot1-0.0.1-SNAPSHOT.jar` 上传到服务器 `/home/docker/docker/MyDockerFile/` 目录下

![image.png](attachments/2023-07-25-12--42-56-485--CZAMfYhWH_zxJA.png)
...
![image.png](attachments/2023-07-25-12--42-56-492--NDG_jziILinmOg.png)
...
![image.png](attachments/2023-07-25-12--42-56-500--D9vGvYY2pppk1g.png)

2. 在 `/home/docker/docker/docker-compose/` 目录下创建 `java`目录

![image.png](attachments/2023-07-25-12--42-56-522--TLasoVlNIXAKMg.png)

3. 进入 `java`目录，放好 jdk、jar

![image.png](attachments/2023-07-25-12--42-56-527--1h67DA_-bhVyRw.png)
...
![image.png](attachments/2023-07-25-12--42-56-532--efCVbPkhsYAbmg.png)
...
![image.png](attachments/2023-07-25-12--42-56-540--lBh0cDKs2s9uBQ.png)

3. 进入 `nginx`目录，放好 vue 编译后的文件夹 dist，并创建 conf 文件夹

![image.png](attachments/2023-07-25-12--42-56-546--NRo29vBnXvkZzQ.png)

4. 进入 `conf`文件夹，创建 `default.conf` 文件，并输入以下内容

![image.png](attachments/2023-07-25-12--42-56-553--JkSYWXX259nd4g.png)
...
![image.png](attachments/2023-07-25-12--42-56-559--rCvzVloYRlcROQ.png)
...
![image.png](attachments/2023-07-25-12--42-56-569--pjyaWz9Vt9_vwQ.png)

6. 浏览器访问后端

![image.png](attachments/2023-07-25-12--42-56-577--t6m4ZU87KQ87IQ.png)
...
![image.png](attachments/2023-07-25-12--42-56-747--rt4sFbU8RApu9g.png)
...
> 
> ![image.png](attachments/2023-07-25-12--42-56-759--E0voctaJILgExA.png)

1. CAdvisor

![image.png](attachments/2023-07-25-12--42-56-806--wFw9N-vHgc1xtg.png)

2. InfluxDB

![image.png](attachments/2023-07-25-12--42-56-830--CZx2nwm_szXPug.png)

3. Granfana

![image.png](attachments/2023-07-25-12--42-56-861--ZclgVLkAxU4gGg.png)

4. 总结

![image.png](attachments/2023-07-25-12--42-56-876--odI1jf8BOLEHaA.png)
