...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/01、Hibernate.png)

- MyBatis

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/02、MyBatis.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/03、去哪里找MyBatis-1.png)

- 官方文档

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/04、去哪里找MyBatis-2.png)

- 下载

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/05、去哪里找MyBatis-3.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/06、往数据库中添加数据.png)

4. 项目结构

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/07、项目结构.png)

5. 导入 jar 包

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/08、导入jar包.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/09、项目结构2.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/10、settings设置.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/11、MyBatis3.4以前手动注册的方式.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/12、批量注册.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/13、insert、update、delete元素.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/14、04_mapper项目结构.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/15、selectKey.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/16、select元素.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/18、id&result.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/17、添加数据.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/19、一级缓存配置.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/20、缓存原理图解.png)

# 七、第三方缓存的整合（ehcache）

1. 新建工程及结构

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/22、新建工程及结构.png)

2. <font color="red">导入整合 ehcache 所需的 jar 包</font>

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/21、第三方缓存的整合（ehcache）.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/23、配置的ehcache缓存文件夹.png)

12. <font color="red">MyBatis 整合第三方缓存的流程图解</font>

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/24、MyBatis整合第三方缓存的流程图解.png)

# 八、MyBatis-Spring整合
1. 查看不同MyBatis版本整合Spring时使用的适配包；
   - http://www.mybatis.org/spring/

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/25、查看不同MyBatis版本整合Spring时使用的适配包.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/26、MyBatis-Spring整合项目结构.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/27、逆向工程结构.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/28、MyBatis分层架构.png)

- MyBatis工作原理

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/29、MyBatis工作原理.png)

## 1、SqlSessionFactory 的初始化

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/30、根据配置文件创建SQLSessionFactory.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/31、SqlSessionFactory的初始化1.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/32、SqlSessionFactory的初始化2.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/33、SqlSessionFactory的初始化3.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/34、SqlSessionFactory的初始化4.png)

## 2、openSession 获取 sqlSession 对象

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/35、openSession获取sqlSession对象.png)

## 3、getMapper 获取到接口的代理对象

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/36、getMapper获取到接口的代理对象.png)

## 4、查询流程的总结

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/37、查询流程的总结.png)

## 5、MyBatis 原理总结

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/38、MyBatis原理总结.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/39、Interceptor接口.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/40、多个插件的运行流程.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/41、开发插件.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/42、游标处理调用实例.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/43、sql语句.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/44、修改数据库tbl_employee表，添加empStatus字段.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/45、数据库保存的结果.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/46、数据库保存的结果2.png)
