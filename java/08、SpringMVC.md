...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/01、创建maven工程.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/02、创建maven工程2.png)

2. 添加 web 模块

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/03、添加web模块.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/04、添加依赖.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/05、创建springmvc配置文件.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/06、项目结构.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/07、解决get获取请求参数的乱码问题.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/08、ModelMap的接口与实现类.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/09、ThymeleafView.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/10、转发视图.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/11、重定向视图.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/12、配置web模块.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/13、引入的vue.js的位置.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/14、导入vue.js与axios.js文件.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/15、测试通过@ResponseBody处理ajax请求.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/16、下载.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/17、错误结果.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/18、DispatcherServlet（前端控制器）初始化过程.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/19、控制台报映射查找不到，客户端展示404错误.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/20、控制台报映射查找不到，客户端展示404错误2.png)

2.  如果有配置，则访问目标资源（一般为静态资源，如：JS,CSS,HTML），找不到客户端也会展示404错误

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/21、访问目标资源，找不到客户端也会展示404错误.png)

![](https://openlist.yuehai.fun:63/d/TakeDown/Java/attachments/22、访问目标资源，找不到客户端也会展示404错误2.png)
