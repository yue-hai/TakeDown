...
![|725](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240506134449.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020230725131943.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/02、Maven项目中模块灰色显示的问题.png)

- 解决：

![](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/03、Maven项目中模块灰色显示的问题2.png)
...
![|351](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240507081955.png)

2. 选择版本

![|700](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240507082040.png)

3. 点击下载 jar 包

![|700](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240507082109.png)

4. 点击 maven 中的 pom，会进入一个新页面，右键另存为，下载

![|700](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240507082741.png)

![|700](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240507083147.png)
...
![](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020240507083426.png)
...
![|700](https://openlist.yuehai.fun:63/d/TakeDown/java/attachments/Pasted%20image%2020231220085046.png)
