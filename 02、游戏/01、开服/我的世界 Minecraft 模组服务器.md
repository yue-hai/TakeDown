...
1. NeoForge 1.20.1：[NeoForge-1.21.1-21.1.116.jar](attachments/NeoForge-1.21.1-21.1.116.jar)
...
4. 下载指定版本的模组加载器：https://files.minecraftforge.net/net/minecraftforge/forge/
	...
	2. forge-1.20.1-47.2.0-installer 版本下载：[forge-1.20.1-47.2.0-installer.jar](attachments/forge-1.20.1-47.2.0-installer.jar)
