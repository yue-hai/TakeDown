...
1. 起因：尝试刷入社区定制版 BIOS，但未注意到固件仅支持 O6，不支持 O6N，导致上电后风扇狂转、黑屏卡死，无法进入 UEFI
2. 解决方案：提取 Radxa 官方 O6N bin 固件，使用 CH341A 烧录器直接飞线物理强刷 SPI 芯片
3. 详细操作步骤：参考我的通用教程笔记： [CH341A 烧录器](../20、维修/CH341A%20烧录器.md)
4. O6N 专属硬件信息：
	1. BIOS 芯片型号：Winbond W25Q64JWSIQ (容量 8MB)
	2. **极度危险警告**：该芯片为 1.8V 供电，物理烧录时必须加接 1.8V 转换适配座，否则会瞬间击穿烧毁
