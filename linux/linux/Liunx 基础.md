...
`It is a test`
### ⑦、显示不换行
`#!/bin/sh echo -e "OK! \c" # -e 开启转义 \c 不换行 `
`echo "It is a test"`
输出结果：
`OK! It is a test`
### ⑧、显示结果保存至文件
...
![](https://cdn.nlark.com/yuque/0/2023/jpeg/29280567/1674957499483-ddd3952e-729f-4d2f-ad45-f86739e71b64.jpeg#averageHue=%23010200&clientId=u4aac431f-0cb1-4&from=paste&id=ue56238de&originHeight=52&originWidth=531&originalType=url&ratio=1&rotation=0&showTitle=false&status=done&style=stroke&taskId=udcd7594a-f433-4883-9c33-87a3b571538&title=)
### ②、`useradd`
...
`touch 文件名`
### ②、参数
![image.png](https://cdn.nlark.com/yuque/0/2022/png/29280567/1659340621373-29425520-bcfc-4d74-a4ab-ae2c0b2ffe5c.png#clientId=u9fd8fed2-0509-4&from=paste&height=324&id=DifwC&name=image.png&originHeight=324&originWidth=450&originalType=binary&ratio=1&rotation=0&showTitle=false&size=26082&status=done&style=stroke&taskId=u6b6599e4-584e-4da3-81c9-2a91072b8c7&title=&width=450)
## 5、移动文件/更改文件名：`mv`
### ①、语法
...
![file-permissions-rwx.jpg](https://cdn.nlark.com/yuque/0/2022/jpeg/29280567/1659403116777-80ff9417-244b-453e-bc41-2d60dff8a8ed.jpeg#clientId=uf2532781-a55c-4&from=drop&id=u120a0d68&name=file-permissions-rwx.jpg&originHeight=340&originWidth=1024&originalType=binary&ratio=1&rotation=0&showTitle=false&size=43469&status=done&style=stroke&taskId=u19e9b829-e84f-4e5a-a70c-4747069e29c&title=)
### ②、语法
...
![rwx-standard-unix-permission-bits.png](https://cdn.nlark.com/yuque/0/2022/png/29280567/1659403220859-571aa18c-4c77-4382-b8da-d748d6cd4021.png#clientId=uf2532781-a55c-4&from=drop&id=ucfb733a4&name=rwx-standard-unix-permission-bits.png&originHeight=400&originWidth=600&originalType=binary&ratio=1&rotation=0&showTitle=false&size=34727&status=done&style=stroke&taskId=ue9e2170c-6cfc-48c1-8239-fc19890dd18&title=)
### ④、绝对模式（八进制数字模式）
...
### ②、vim 键盘图
![vi-vim-cheat-sheet-sch.gif](https://cdn.nlark.com/yuque/0/2022/gif/29280567/1659333754275-aa5ed4d5-9b3b-4171-80cd-95ef4b7a0d68.gif#clientId=ud36ce0be-1246-4&from=drop&id=Etk0M&name=vi-vim-cheat-sheet-sch.gif&originHeight=724&originWidth=1024&originalType=binary&ratio=1&rotation=0&showTitle=false&size=134161&status=done&style=stroke&taskId=u0d343693-1578-41a1-9f16-0d54fe53a16&title=)
### ③、vi/vim 的使用
:::info
...
### ④、vi/vim 工作模式
![vim-vi-workmodel.png](https://cdn.nlark.com/yuque/0/2022/png/29280567/1659334220989-496bc2fa-9200-4d20-b6e7-61f1de04bc54.png#clientId=u9fd8fed2-0509-4&from=drop&id=ZSkjn&name=vim-vi-workmodel.png&originHeight=531&originWidth=787&originalType=binary&ratio=1&rotation=0&showTitle=false&size=62780&status=done&style=stroke&taskId=u9912efe8-3119-40de-94c8-c1e3d24735b&title=)
### ⑤、按键：复制粘贴、搜索替换等
| **一般模式可用的命令** |  |
| --- | --- |
...
##### （2）、`printf`
![image.png](https://cdn.nlark.com/yuque/0/2022/png/29280567/1660101400561-1632d4b1-c695-452f-9ec8-061f35bdd535.png#clientId=ue41a64e5-79c6-4&from=paste&height=431&id=u2ceb2e92&name=image.png&originHeight=431&originWidth=774&originalType=binary&ratio=1&rotation=0&showTitle=false&size=104563&status=done&style=stroke&taskId=u606b772a-d193-457c-be48-63180521fbc&title=&width=774)
