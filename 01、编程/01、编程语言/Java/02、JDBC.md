...
![](attachments/02、如果没有JDBC，那么Java程序访问数据库时是这样的.png)

5. 有了 JDBC，Java 程序访问数据库时是这样的：

![](attachments/03、有了JDBC，Java程序访问数据库时是这样的.png)

6. 总结如下：

![](attachments/04、JDBC总结如下.png)
...
![](attachments/10、MySQL的Driver实现类的源码.png)
...
![](attachments/13、用PreparedStatement取代Statement.png)
...
![](attachments/14、ResultSet与ResultSetMetaData.png)
...
![](attachments/15、ResultSetMetaData.png)
...
![](attachments/16、ResultSetMetaData2.png)
...
![](attachments/17、数据库提供的4种事务隔离级别.png)
...
![](attachments/19、数据库连接池.png)

![](attachments/20、数据库连接池的工作原理.png)
...
![](attachments/21、c3p0需导入的jar包.png)
...
![](attachments/22、dbcp需导入的jar包.png)
...
![](attachments/23、Druid（德鲁伊）需导入的jar包.png)
...
![](attachments/24、Apache-DBUtils需导入的jar包.png)

![](attachments/25、Apache-DBUtils的接口.png)
